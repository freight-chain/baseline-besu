...
var BesuProvider = /** @class */ (function(_super) {
  ...
  BesuProvider.prototype.getNodeInfo =
      function() { return this._runPerform("getNodeInfo", {}); };
  BesuProvider.prototype.getPeers =
      function() { return this._runPerform("getPeers", {}); };
  ...
  // Miscellaneous
  BesuProvider.prototype.getModuleVersions =
      function() { return this._runPerform("getModuleVersions", {}); };
  // Txpool
  BesuProvider.prototype.getBesuStatistics =
      function() { return this._runPerform("getBesuStatistics", {}); };
  BesuProvider.prototype.getBesuTransactions =
      function() { return this._runPerform("getBesuTransactions", {}); };
  // Clique
  ...
  BesuProvider.prototype.cliqueGetProposals =
      function() { return this._runPerform("cliqueGetProposals", {}); };
  // IBFT
  BesuProvider.prototype.ibftDiscardValidatorVote = function(validatorAddress) {
    return this._runPerform("ibftDiscardValidatorVote", {
      validatorAddress :
          function() { return Promise.resolve(validatorAddress); }
    });
  };
  BesuProvider.prototype.ibftGetPendingVotes =
      function() { return this._runPerform("ibftGetPendingVotes", {}); };
  BesuProvider.prototype.ibftGetValidatorsByBlockHash = function(hash) {
    return this._runPerform(
        "ibftGetValidatorsByBlockHash",
        {hash : function() { return Promise.resolve(hash); }});
  };
  BesuProvider.prototype.ibftGetValidatorsByBlockNumber = function(
      blockParameter) {
    return this._runPerform("ibftGetValidatorsByBlockNumber", {
      blockParameter : function() { return Promise.resolve(blockParameter); }
    });
  };
  BesuProvider.prototype.ibftProposeValidatorVote = function(validatorAddress,
                                                             add) {
  ...
  BesuProvider.prototype.getAccountsWhitelist =
      function() { return this._runPerform("getAccountsWhitelist", {}); };
  ...
  BesuProvider.prototype.getNodesWhitelist =
      function() { return this._runPerform("getNodesWhitelist", {}); };
  BesuProvider.prototype.removeNodesFromWhitelist = function(nodes) {
    return this._runPerform("removeNodesFromWhitelist", {
      nodes : function() { return Promise.resolve(nodes); },
    });
  };
  BesuProvider.prototype.reloadPermissionsFromFile =
      function() { return this._runPerform("reloadPermissionsFromFile", {}); };
