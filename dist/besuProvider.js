...
var BesuProvider = /** @class */ (function (_super) {
  ...
  BesuProvider.prototype.addPeer = function (enodeUrl) {
    return this._runPerform("addPeer", {
      enodeUrl: function () {
        return Promise.resolve(enodeUrl);
      },
    });
  };
  ...
  BesuProvider.prototype.cliqueGetSigners = function (blockParameter) {
    return this._runPerform("cliqueGetSigners", {
      blockParameter: function () {
        return Promise.resolve(blockParameter);
      },
    });
  };
  ...
  // IBFT
  BesuProvider.prototype.ibftDiscardValidatorVote = function (
    validatorAddress
  ) {
    return this._runPerform("ibftDiscardValidatorVote", {
      validatorAddress: function () {
        return Promise.resolve(validatorAddress);
      },
    });
  };
  ...
  BesuProvider.prototype.ibftProposeValidatorVote = function (
    validatorAddress,
    add
  ) {
  ...
  BesuProvider.prototype.perform = function (method, params) {
    switch (method) {
      // administration
      case "addPeer":
        return this.send("admin_addPeer", [params.enodeUrl]);
      case "changeLogLevel":
        return this.send("admin_changeLogLevel", [params.level]);
      case "getNodeInfo":
        return this.send("admin_nodeInfo", []);
      case "getPeers":
        return this.send("admin_peers", []);
      case "removePeer":
        return this.send("admin_removePeer", [params.enodeUrl]);
      // Miscellaneous
      ...
      // Clique
      case "cliqueDiscard":
        return this.send("clique_discard", [params.signerAddress]);
      case "cliqueGetSigners":
        return this.send("clique_getSigners", [params.blockParameter]);
      case "cliqueGetSignersAtHash":
        return this.send("clique_getSignersAtHash", [params.hash]);
      case "cliquePropose":
        return this.send("clique_propose", [params.signerAddress, params.add]);
      ...
      case "ibftGetValidatorsByBlockHash":
        return this.send("ibft_getValidatorsByBlockHash", [params.hash]);
