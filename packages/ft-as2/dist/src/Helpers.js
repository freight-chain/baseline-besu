...
exports.request = exports.agreementOptions = exports.encryptionOptions =
    exports.signingOptions = exports.canonicalTransform = exports.isSMime =
        exports.isNullOrUndefined = exports.getProtocol =
            exports.parseHeaderString = void 0;
...
function signingOptions(sign) {
  return Object.assign(
      {cert : "", key : "", chain : [], micalg : Constants_1.SIGNING.SHA256},
      sign);
}
exports.signingOptions = signingOptions;
/** Normalizes encryption options. */
function encryptionOptions(encrypt) {
  return Object.assign({cert : "", encryption : Constants_1.ENCRYPTION._3DES},
                       encrypt);
}
...
function agreementOptions(agreement) {
  const {mdn} = agreement;
  const {sign} = mdn;
  return Object.assign(Object.assign({version : "1.0"}, agreement), {
    mdn : isNullOrUndefined(mdn) ? mdn : Object.assign(Object.assign({}, mdn), {
      sign : isNullOrUndefined(sign)
                 ? sign
                 : Object.assign(
                       {importance : "required", protocol : "pkcs7-signature"},
                       sign),
    }),
  });
}
...
/**
 * Convenience method for making AS2 HTTP/S requests. Makes a POST request by
 * default.
 */
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      Object.entries(params || {})
          .forEach((val) => url.searchParams.append(...val));
      const responseBufs = [];
