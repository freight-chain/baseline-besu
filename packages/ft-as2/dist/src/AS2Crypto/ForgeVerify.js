...
function verify(verifier) {
  ...
  // Find the signer info by cert issuer and capture signature, algorithm, and
  // signed attributes from signer info.
  const {
    authenticatedAttributes,
    digestAlgorithm,
    signature,
  } = findSignerInfo(cert, msg.rawCapture.signerInfos);
